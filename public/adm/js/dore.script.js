    ...
    function init() {
        ...
        if (typeof Chart !== "undefined") {
                ...
                tooltips: {
                    ...
                    custom: function(tooltipModel) {
                        if (tooltipModel && tooltipModel.dataPoints) {
                            ...
                            $textContainer.find(".value").html($.fn.addCommas(formatter.format(yLabel)));
            ...
            if (document.getElementById("smallChart1")) {
                ...
                var domingo = $('#smallChart1').attr('data-domingo');
                var segunda = $('#smallChart1').attr('data-segunda');
                var terca = $('#smallChart1').attr('data-terca');
                var quarta = $('#smallChart1').attr('data-quarta');
                var quinta = $('#smallChart1').attr('data-quinta');
                var sexta = $('#smallChart1').attr('data-sexta');
                var sabado = $('#smallChart1').attr('data-sabado');
                ...
                var myChart = new Chart(smallChart1, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            fill: false,
                            borderWidth: 2,
                            data: [domingo, segunda, terca, quarta, quinta, sexta, sabado],
                            datalabels: {
                                align: "end",
                                anchor: "end"
                            }
            ...
            if (document.getElementById("smallChart2")) {
                ...
                var domingo = $('#smallChart2').attr('data-domingo');
                var segunda = $('#smallChart2').attr('data-segunda');
                var terca = $('#smallChart2').attr('data-terca');
                var quarta = $('#smallChart2').attr('data-quarta');
                var quinta = $('#smallChart2').attr('data-quinta');
                var sexta = $('#smallChart2').attr('data-sexta');
                var sabado = $('#smallChart2').attr('data-sabado');
            ...
            if (document.getElementById("categoryChart")) {
                ...
                var Dinheiro = $(categoryChart).attr('data-Dinheiro');
                var Debito = $(categoryChart).attr('data-Debito');
                var Credito = $(categoryChart).attr('data-Credito');
                var VR = $(categoryChart).attr('data-VR');
                var VA = $(categoryChart).attr('data-VA');
                var QRCode = $(categoryChart).attr('data-QRCode');
                ...
                var myDoughnutChart = new Chart(categoryChart, {
                    ...
                    data: {
                        labels: ["Dinheiro", "Cartão Débito", "Cartão Crédito", "VR", "VA", "QRCode"],
                        datasets: [{
                            label: "",
                            borderColor: [themeColor6, themeColor5, themeColor4, themeColor3, themeColor2, themeColor1],
                            backgroundColor: [
                                themeColor6_10,
                                themeColor5_10,
                                themeColor4_10,
                            ...
                            borderWidth: 2,
                            data: [Dinheiro, Debito, Credito, VR, VA, QRCode]
                        }]
                    },
                    draw: function() {},
                    options: {
