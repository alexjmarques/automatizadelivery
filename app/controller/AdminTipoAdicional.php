...
$empresa = $this->acoes->getByField('empresa', 'link_site', $data['linkSite']);
        ...
        if ($result <= 0) {
            ...
            echo 'Tipo Adicional cadastrado com sucesso';
        }
    }
...
$empresa = $this->acoes->getByField('empresa', 'link_site', $data['linkSite']);
        ...
        if ($result <= 0) {
            ...
            echo 'Tipo Adicional atualizar com sucesso';
        }
    }
...
$empresa = $this->acoes->getByField('empresa', 'link_site', $data['linkSite']);
    ...
    private function getInput()
    {
        return (object)[
            ...
            'tipo_escolha' => Input::post('tipo_escolha'),
            'qtd' => Input::post('qtd'),
            'status' => Input::post('switch'),
