...
class AdminProdutosSabores extends Controller
{
    ...
    public function index($data)
    {
        ...
        $count = $this->acoes->counts('produtoSabor', 'id_empresa', $empresa->id);
        $page = filter_input(INPUT_GET, "page", FILTER_VALIDATE_INT);
        $pager = new \CoffeeCode\Paginator\Paginator();
        $pager->pager((int)$count, 30, $page);
        $retorno = $this->acoes->pagination('produtoSabor', 'id_empresa', $empresa->id, $pager->limit(), $pager->offset(), 'id ASC');

        $this->load('_admin/produtoSabor/main', [
            'produtoSabor' => $retorno,
    ...
    public function novo($data)
    {
        ...
        $this->load('_admin/produtoSabor/novo', [
            'planoAtivo' => $planoAtivo,
            'moeda' => $moeda,
            'empresa' => $empresa,
            'endEmp' => $endEmp,
    ...
    public function editar($data)
    {
        ...
        $this->load('_admin/produtoSabor/editar', [
            'retorno' => $retorno,
            'planoAtivo' => $planoAtivo,
            'moeda' => $moeda,
            'empresa' => $empresa,
    ...
    public function deletar($data)
    {
        ...
        redirect(BASE . "{$data['estado']}/{$data['linkSite']}/admin/produtos-sabores");
    }
}
