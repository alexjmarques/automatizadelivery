...
class Model
{
    ...
    public function __construct()
    {
        ...
        $this->server   =  DATA_LAYER_CONFIG['host'];
        $this->user     =  DATA_LAYER_CONFIG['username'];
        $this->password =  DATA_LAYER_CONFIG['passwd'];
        $this->database =  DATA_LAYER_CONFIG['dbname'];
        $this->port     =  DATA_LAYER_CONFIG['port'];
    }
    ...
    public function getConnection()
    {
        try {
            if (self::$connection == null) {
                self::$connection = new PDO("mysql:host={$this->server};dbname={$this->database};port={$this->port};charset=utf8", $this->user, $this->password);
