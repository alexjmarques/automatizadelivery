...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <form method="post" autocomplete="off" id="form" class="form" action="{{BASE}}{{empresa.link_site}}/admin/plano/selecionado/contratar" autocomplete="off" enctype="multipart/form-data">
                <div class="card mb-4">
                    <div class="card-body">
