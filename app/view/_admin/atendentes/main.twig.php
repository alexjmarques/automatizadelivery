        ...
        <table class="data-table data-table-simple responsive nowrap" >
                    ...
                    {% for user in usuarios %}
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{BASE}}{{empresa.link_site}}/admin/atendente/editar/{{ user.id }}" class="btn btn-outline-success mb-1" ata-toggle="modal" data-target="#rightModal"><i class="simple-icon-note"></i> Editar</a>
                                {% if nivelUsuario == 0 %}
