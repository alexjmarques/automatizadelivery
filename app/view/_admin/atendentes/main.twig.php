        ...
        <table class="data-table data-table-simple responsive nowrap" >
                    ...
                    {% for user in usuarios %}
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{BASE}}{{empresa.link_site}}/admin/atendente/editar/{{ user.id }}" class="btn btn-outline-success" ata-toggle="modal" data-target="#rightModal"><i class="simple-icon-note"></i></a>
                                {% if nivelUsuario == 0 %}
