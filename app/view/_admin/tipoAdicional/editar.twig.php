...
{% block body %}
<h1>Editar Categoria Adicional</h1>
...
<form method="post" id="form" action="{{BASE}}{{empresa.link_site}}/admin/tipo-adicional/u/{{retorno.id}}"
    enctype="multipart/form-data">
    <div class="card mb-4">
        <div class="card-body">
            <h5 id="titleBy" data-id="{{retorno.id}}">Categoria do Adicional</h5>
            <div class="form-row">
                <div class="form-group col-md-5 catProds">
                    <label>Categoria</label>
                    <input type="text" class="form-control" id="tipo" name="tipo"
                        value="{{retorno.tipo}}" required>
                </div>
                ...
                <div class="form-group col-md-3">
                    <div class="form-group position-relative">
                        ...
                        <select class="form-control select2-single" id="tipo_escolha" name="tipo_escolha">
                            <option value="1" {% if retorno.tipo_escolha==0 %}selected{% endif %}>Opcional
                            </option>
                            <option value="2" {% if retorno.tipo_escolha==1 %}selected{% endif %}>
                                Obrigatório</option>
                            <option value="3" {% if retorno.tipo_escolha==2 %}selected{% endif %}>
                                Obrigatório até X escolha</option>
                        </select>
                    </div>
                </div>
                ...
                <div id="tipo_escolhaQtd"
                    class="form-group col-md-3 {% if retorno.tipo_escolha == 1 %}show{% endif %} {% if retorno.tipo_escolha == 2 %}show{% endif %}">
