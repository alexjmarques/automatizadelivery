...
<div class="separator mb-5"></div>
                <form method="post" id="form"  action="{{BASE}}{{empresa.link_site}}/admin/produto/i" enctype="multipart/form-data">
                <div class="card mb-4">
                    <div class="card-body">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            {% if qtdSabores == 0 %}
                                <div class="alert alert-warning" role="alert"> Para cadastrar um novo produdo com todos os detalhes e {{preferencias.sabores()}}! <a href="{{BASE}}{{empresa.link_site}}/admin/produto-sabor/novo">Clique aqui</a> para Cadastrar.</div>
                            {% else %}
