    ...
    <div class="col-12 data-tables-hide-filter">
        <div class="card">
            <div class="card-body">
                <table class="data-table data-table-simple responsive" data-order='[[ 2, "asc" ]]'>
                    ...
                    <tbody>
                        ...
                        <tr style="width: 100px;">
                            ...
                            <td>
                            {% if p.valor == 0.00 %}
                                <a href="{{BASE}}{{empresa.link_site}}/admin/produto-pizza/editar/{{ p.id }}" class="btn btn-outline-success mb-1" ata-toggle="modal" data-target="#rightModal"><i class="simple-icon-note"></i> Editar</a>
                                {% else %}
                ...
                <div class="col-7 center-block text-center float-ceter">{{paginacao|raw}}</div>
            </div>
        </div>
    </div>
</div>
