            ...
            <div id="step-2">
                <div class="osahan-checkout">
                    ...
                    <tbody>
                                ...
                                {% endif %}
                                            ...
                                            <p class="m-0 small subprice">
                                                - <strong>{{ cartAd.quantidade }}
                                                    x </strong>{{ a.nome }} <span
                                                    class="moeda_valor right text-bold-18">{{ moeda.simbolo }} {{
                            ...
                            <div class="mb-3 p-3 py-3 col-md-6 float-left cinza">
                                ...
                                <div class="mb-0 input-group full-width mt-2">
                                    <hr>
                                    <h5 class="full-width pb-0">Farmas de Pagamento</h5>
                                ...
                                <div id="trocoMod" class="mt-1">
                                    ...
                                    <input type="text" class="form-control" id="trocoCli"
                                        placeholder="Total em Dinheiro" name="trocoCli">
                                ...
                                <div class="mb-0 input-group full-width mt-0">
                                    ...
                                    <div class="clearfix"></div>
                                    <textarea name="observacao" id="observacao" placeholder=""
                                ...
                                <div class="full-width pt-4 pb-4">
                                    ...
                                    {% if km <= km_entrega_excedente %} <p class="mb-1" id="freteCal">Taxa de
                                        ...
                                        {% else %}
                                        <input type="hidden" name="total_pago" id="total_pago"
                                            value="{{ calculoFrete + valorPedido }}">
                                        ...
                                        {% else %}
                                        <h6 class="font-weight-bold mb-0">Total <span class="float-right"> <span
                                                    id="valorProdutoMostra">{{ moeda.simbolo }} {{ (calculoFrete +
                                                    valorPedido)|number_format(2, ',', '.') }}</span></span></h6>
                                        {% endif %}
