...
<div class="card mb-4">
    <div id="smartWizardPedidos" class="sw-main sw-theme-check">
        ...
        <a href="{{BASE}}{{empresa.link_site}}/admin/pedido/novo/produtos/detalhes"
            class="btn btn-success btn-block btn-lg btn-sm btnFPedido {% if carrinhoqtd == 0 %}hide{% endif %}">Finalizar
            Pedido</a>
        ...
        <div class="card-body">
            <div id="step-1" class="tab-pane step-content" style="display: block;">
                ...
                <div class="px-3 pt-3 title d-flex bg-white">
                    <h5 id="{{ c.slug }}" name="{{ c.slug }}" class="mt-1"><strong>{{ c.nome }}</strong></h5>
                    <hr>
                </div>
                {% endif %}
                <ul class="lista">
                    ...
                    <li class="col-md-4 disable-text-selection bg-white" data-toggle="modal" data-target="#modProduto"
                        onclick="produtoModal({{p.id}})">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <img src="{{BASE}}uploads/{{p.imagem}}" class="card-img-top"
                                                style="float: left;width: 90px;margin: 0 5px 0 0;border-radius: 5px;">
                                            {% endif %}
                                            <h6 class="mb-1">
                                            ...
                                            <p class="text-black mb-1 dequanto pmais"><span
                                                    class="float-left por mr-2">De</span> <span
                                                    class="float-left text-black-50"> {{moeda.simbolo}} {{
                                                    p.valor|number_format(2, ',', '.') }}</span></p>
                                            <p class="text-black mb-1 porquanto pmais"> <span
                                                    class="float-left por pl-4 mr-2">Por</span> <span
                                                    class="float-left text-black-50"> {{moeda.simbolo}} {{
