...
<div class="containers row-wrap stretch">
	<div class="col-4 p-2 shadow bg-white">
		<div id="titleBy" data-id="{{cliente.id}}" class="resumo-pedido" data-cliente="{{cliente.id}}" data-pedido-cliente="{{pedido.numero_pedido}}">
			...
			<div id="mostraCarrinhoItensEditar"></div>
			<div id="carregaCarrinhoEditar"></div>
		</div>
	</div>
	...
	<div class="mb-4 col-8 roll">
		<div id="step-1" class="tab-pane step-content" style="display: block;">
			...
			<div class="px-3 pt-3 title">
				...
				<div class="osahan-slider-item col-3 float-left pb-4 pl-0 px-1">
					<div class=" h-100 overflow-hidden position-relative">
						<button class="p-2 position-relative btn-categoria pizza" data-toggle="modal" data-target="#modProduto" onclick="produtoPizzaModalEditar({{ tam.id }}, {{cliente.id}}, {{pedido.numero_pedido}})">
                ...
                <div class="px-3 pt-3 title">
                    ...
                    <div class="osahan-slider-item col-3 float-left pb-4 pl-0 px-1">
                        <div class="list-card h-100 overflow-hidden position-relative">
                            <button class="p-2 position-relative" data-toggle="modal" data-target="#modProduto" onclick="produtoPizzaModalEditar('{{c.slug}}', {{tc.id}}, {{tam.id}}, {{i}}, {{cliente.id}}, {{pedido.numero_pedido}})">
                                <div class="list-card-body">
                                    <h6 class="mb-1">
			...
			<ul class="lista">
				...
				<li class="col-md-4 disable-text-selection" data-toggle="modal" data-target="#modProduto" onclick="produtoModalEditar({{p.id}}, {{cliente.id}},{{pedido.numero_pedido}})">
