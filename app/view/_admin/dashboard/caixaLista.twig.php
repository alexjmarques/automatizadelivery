        ...
        <table class="data-table data-table-simple responsive nowrap">
                    ...
                    <tbody>
                        {% for c in caixas %}
                            ...
                            <tr>
                                <td>
                                <p class="text-muted"><a href="{{BASE}}{{empresa.link_site}}/admin/caixa/dia/{{ c.id }}">Dia ({{ c.data_inicio|date('m-d') }})</a></p>
                                </td>
                                <td>
                                <p class="text-muted"><a href="{{BASE}}{{empresa.link_site}}/admin/caixa/dia/{{ c.id }}">{{ c.data_inicio|date('d/m/Y') }}</a></p>
                                </td>
                                <td>
