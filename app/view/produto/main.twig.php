    ...
    <div class="p-3 osahan-cart-item osahan-home-page">
        ...
        <form method="post" id="form" action="{{BASE}}{{empresa.link_site}}/produto/addCarrinho/{{produto.id}}">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-danger btn-number quantity-left-minus"
                                data-type="minus" data-field=""><span class="feather-minus"></span></button>
                        </span>
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-success btn-number quantity-right-plus"
                                data-type="plus" data-field=""><span class="feather-plus"></span></button>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="mdc-card" id="add_itenSabores">
                        ...
                        <div class="custom-control custom-radio border-bottom py-2">
                            <input class="custom-control-input" type="radio" id="id_sabor{{padici.id}}"
                                name="sabores[]" value="{{padici.id}}">
            ...
            <div class="alert alert-warning text-center mt-3" role="alert">No momento, não estamos aceitando novos
                pedidos. Nosso horário de atendimento e {% if empresa.diasAtendimento == "2,3,4,5,6" %}de
                Terça-feira a Sábado{% endif%}{% if empresa.diasAtendimento == "2,3,4,5,6,7" %}de Terça-feira a
                Domingo{% endif%}{% if empresa.diasAtendimento == "1,2,3,4,5" %}de Segunda-feira a Sexta-feira{%
                endif%}{% if empresa.diasAtendimento == "1,2,3,4,5,6" %}de Segunda-feira a Sábado{% endif%}{% if
                empresa.diasAtendimento == "1,2,3,4,5,6,7" %}Todos os dias{% endif%} das {{
                delivery.abertura|date('H:i')}}h às {{ delivery.fechamento|date('H:i')}}h</div>
            {% endif%}
    </div>
    <form>
</div>
