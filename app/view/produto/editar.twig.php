...
<button class="btn btn-success btn-block btn-lg addStyle">ATUALIZAR ITEM <i class="feather-shopping-cart"></i></button>
            {% else %}
                
<button class="btn btn-info btn-block btn-lg addStyle">CONTINUAR <i class="feather-next"></i></button>
            {% endif %}
        {% endif %}
        {% endif %}
