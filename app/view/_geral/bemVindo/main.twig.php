...
<div class="osahan-slider">
    <div class="osahan-slider-item text-center">
        <div class="d-flex align-items-center justify-content-center vh-100 flex-column">
            <img src="{{BASE}}img/location.png" class="img-fluid mx-auto" alt="{{empresa[':nomeFantasia']}}">
            <h4 class="my-4 text-dark">Veja como e Fácil</h4>
            <p>Faça seu cadastro, informe seu endereço para visualizar o cardápio e fazer seu pedido.</p>
        </div>
    </div>
    <div class="osahan-slider-item text-center">
        <div class="d-flex align-items-center justify-content-center vh-100 flex-column">
            <img src="{{BASE}}img/landing2.png" class="img-fluid mx-auto" alt="{{empresa[':nomeFantasia']}}">
    ...
    <div class="osahan-slider-item text-center">
        <div class="d-flex align-items-center justify-content-center vh-100 flex-column">
            <img src="{{BASE}}img/landing3.png" class="img-fluid mx-auto" alt="{{empresa[':nomeFantasia']}}">
