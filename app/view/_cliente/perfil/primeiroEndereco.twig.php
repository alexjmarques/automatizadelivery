...
<form  method="post" id="form"  action="{{BASE}}{{empresa.link_site}}/endereco/i" novalidate>
    ...
    <p class="mb-0 text-center p-3 pb-0"><span class="sx-20">Legal <strong>{{usuarioAtivo.nome}}</strong>!</span> <br/> Agora preciso que me inform o endereço para entrega!</p>
...
<button class="btn btn-success btn-block btn-lg acaoBtn btnFinalizaCadastro">FINALIZAR CADASTRO</button>
</form>
</div>
</div>
