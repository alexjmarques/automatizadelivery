    ...
    <div class="d-flex  border-bottom p-3">
        <div class="left mr-3">
            <svg version="1.1" class="svg" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 460.8 460.8"
...
<div class="bg-white rounded shadow mt-3 profile-details">
    <a href="{{BASE}}{{empresa.link_site}}/enderecos" class="d-flex w-100  border-bottom p-3">
        <div class="left mr-3">
            <h6 class="font-weight-bold mb-1 text-dark">Meus Endereços</h6>
            <p class="small text-muted m-0">Cadastre ou delete endereços de entrega</p>
        </div>
        <div class="right ml-auto">
            <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
        </div>
    </a>
    <a href="{{BASE}}{{empresa.link_site}}/dados-cadastrais" class="d-flex w-100  border-bottom p-3">
        <div class="left mr-3">
            <h6 class="font-weight-bold mb-1 text-dark">Alterar Dados</h6>
            <p class="small text-muted m-0">Faça a atualização do dados Cadastrais</p>
        </div>
        <div class="right ml-auto">
            <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
        </div>
    </a>
    <!-- <a href="{{BASE}}{{empresa.link_site}}/alterar-senha" class="d-flex w-100  border-bottom p-3">
        <div class="left mr-3">
    ...
    <a href="{{BASE}}{{empresa.link_site}}/delivery" class="d-flex w-100  border-bottom px-3 py-4">
        <div class="left mr-3">
            <h6 class="font-weight-bold m-0 text-dark"><i
                    class="feather-truck bg-success text-white p-2 rounded-circle mr-2"></i> Informações do Delivery
            </h6>
        </div>
        <div class="right ml-auto">
            <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
    ...
    <a href="{{BASE}}{{empresa.link_site}}/fale-conosco" class="d-flex w-100  border-bottom px-3 py-4">
        ...
        <a href="{{BASE}}{{empresa.link_site}}/politica-de-privacidade" class="d-flex w-100  px-3 py-4">
            <div class="left mr-3">
                <h6 class="font-weight-bold m-0 text-dark"><i
                        class="feather-lock bg-warning text-white p-2 rounded-circle mr-2"></i> Política de Privacidade
                </h6>
            </div>
            <div class="right ml-auto">
                <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
