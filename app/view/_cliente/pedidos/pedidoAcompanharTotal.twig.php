            ...
            <div class="bg-white shadow mb-3 ">
                ...
                <div class="gold-members d-flex justify-content-between px-3 py-2 border-bottom">
                <p class="text-muted m-0 __cf_email__"><span class="medium">Seu pedido e do tipo <strong  class="subprice">{% for t in tipo_frete %}
                        {% if t[':id'] == venda[':tipo_frete'] %}
                            {{t[':tipo']}}
                        {%endif%}
                    {% endfor %}</strong> </span> <br/><span class="medium">Pagamento via <strong class="subprice">{% for t in tipo_pagamento %}
