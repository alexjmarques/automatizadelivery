...
<div class="bg-white rounded shadow mt-3 profile-details">
    <a href="{{BASE}}{{empresa.link_site}}/motoboy/dados-veiculo" class="d-flex w-100  border-bottom p-3">
        <div class="left mr-3">
            <h6 class="font-weight-bold mb-1 text-dark">Diaria e Veículo</h6>
            <p class="small text-muted m-0">Atualize as informações de seu veículo</p>
        </div>
